...
import (
	...
	"github.com/tddey01/aria2/lib/model"
...
type GetOfflineDealsByStatusResponse struct {
	Data struct {
		OfflineDeals []*models.FilSwan `json:"offline_deals"`
	} `json:"data"`
	Status string `json:"status"`
}

func (swanClient *SwanClient) GetOfflineDealsByStatus(params GetOfflineDealsByStatusParams) ([]*models.FilSwan, error) {
